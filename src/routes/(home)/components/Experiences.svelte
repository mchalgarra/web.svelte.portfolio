...
<div class="flex flex-col gap-16 pt-24 sm:pt-32">
	<h1 class="text-100 text-6xl font-bold text-center m-0">Experience</h1>

	<div class="flex flex-col gap-16 max-md:gap-12">
